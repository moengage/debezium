...
Read More at [debezium-connector-mongodb](https://github.com/moengage/debezium/tree/debezium-connector-mongodb/1.5.0-collection/debezium-connector-mongodb)
